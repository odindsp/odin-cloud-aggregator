...
public class ExcelUtil
{
    ...
    public List<Row> readExcel(String xlsPath) throws IOException
    {
        ...
        try
        {
            ...
            {
                return readXlsExcel(xlsPath);
            }
            else if ("xlsx".equals(ext))// 使用xlsx方式读取
            {
                return readXlsxExcel(xlsPath);
            }
    ...
    public void writeExcel(List<Row> rowList, String xlsPath) throws IOException
    {
        ...
        try
        {
            ...
            {
                writeXlsExcel(rowList, xlsPath);
            }
            else if ("xlsx".equals(ext)) // 使用xlsx方式写入
            {
                writeXlsxExcel(rowList, xlsPath);
            }
     ...
     * @throws IOException
     */
    public void writeXlsExcel(List<Row> rowList, String distXlsPath) throws IOException
    {
        writeXlsExcel(rowList, excelPath, distXlsPath);
    }
     ...
     * @throws IOException
     */
    public void writeXlsExcel(List<Row> rowList, String srcXlsPath, String distXlsPath) throws IOException
    {
        // 判断文件路径是否为空
     ...
     * @throws IOException
     */
    public void writeXlsxExcel(List<Row> rowList, String distXlsPath) throws IOException
    {
        writeXlsExcel(rowList, excelPath, distXlsPath);
    }
     ...
     * @throws IOException
     */
    public void writeXlsxExcel(List<Row> rowList, String srcXlsPath, String distXlsPath) throws IOException
    {
     ...
     * @throws IOException
     */
    public List<Row> readXlsxExcel() throws IOException
    {
        return readXlsxExcel(excelPath);
    }
     ...
     * @throws Exception
     */
    public List<Row> readXlsxExcel(String xlsPath) throws IOException
    {
        // 判断文件是否存在
        File file = new File(xlsPath);
        if (!file.exists())
     ...
     * @throws IOException
     */
    public List<Row> readXlsExcel() throws IOException
    {
        return readXlsExcel(excelPath);
    }
     ...
     * @throws Exception
     */
    public List<Row> readXlsExcel(String xlsPath) throws IOException
    {
     ...
     * @return
     */
    private void setMergedRegion(Sheet sheet)
    {
